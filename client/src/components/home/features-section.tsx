        ...
        {features.map((feature, index) => (
          <div 
            ...
            className={`rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 ${
              isDark 
                ? "bg-wizardLight" 
                : "bg-white/90 border border-wizardDark/10"
            }`}
          >
            ...
            <div className="mt-5 text-center">
              <Link href={feature.link}>
                <a className="text-gold hover:text-hufflepuff transition-colors duration-300 font-display">
